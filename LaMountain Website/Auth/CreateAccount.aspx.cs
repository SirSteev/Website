...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (TbNameFirst.Text.Length < 1 ||
            ...
            TbConfirmPassword.Text.Length < 1)
        {
        ...
        if (TbPassword.Text.Length < Validator.minPasswordLength || TbConfirmPassword.Text.Length < Validator.minPasswordLength)
        {
        ...
        if (!errorFlagInvalid && !errorFlagMissing && !errorFlagContainsBadWords && !errorPasswordNoMatch && !errorPasswordTooShort)
        {
            SubmitInformation();
    ...
    private void InformationCheck()
    {
        ...
        if (TbPassword.Text.Length < Validator.minPasswordLength || TbPassword.Text != TbConfirmPassword.Text)
        {
        ...
        if (TbConfirmPassword.Text.Length < Validator.minPasswordLength || TbPassword.Text != TbConfirmPassword.Text)
        {
    ...
    private void SubmitInformation()
    {
        ...
        if (feedback == "")
        {
            LbHeaderError.Text = "Information submition successful, Please log in --->";
        }
        else
        {
            LbHeaderError.Text = feedback;
